  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Ravenna plan</button>
      </div>
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">Guidance is indicative — always confirm your ship&apos;s all-aboard time and build a 60–90 minute return buffer. Post-cruise Venice is one-way and does not return to the ship.</p>
        </div>
      )}
    </div>
  );
