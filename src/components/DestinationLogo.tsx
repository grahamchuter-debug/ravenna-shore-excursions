...
function MarkSvg({
  ...
  if (concept === "mosaic-arch") {
    // Concept C (active): Byzantine round arch (San Vitale silhouette) inlaid
    // with a small tessera (mosaic tile) grid in the gold accent, with a
    // restrained anchor stem hinting at the cruise-port context.
    return (
      <svg
        width={size}
        height={size}
      ...
      >
        ...
        {/* Byzantine round arch */}
        <path
          d="M9.5 30.5V19.5a10.5 10.5 0 0 1 21 0v11"
          stroke={ink}
          strokeWidth="1.85"
          strokeLinecap="round"
        />
        {/* Tessera grid inside the arch — mosaic tile accent */}
        <g fill={accent}>
          <rect x="14.2" y="18.4" width="2.1" height="2.1" rx="0.4" />
          <rect x="17.1" y="16.4" width="2.1" height="2.1" rx="0.4" />
          <rect x="20.0" y="15.4" width="2.1" height="2.1" rx="0.4" />
          <rect x="22.9" y="16.4" width="2.1" height="2.1" rx="0.4" />
          <rect x="25.7" y="18.4" width="2.1" height="2.1" rx="0.4" />
        </g>
        <g fill={soft}>
          <rect x="14.2" y="21.6" width="2.1" height="2.1" rx="0.4" />
          <rect x="17.1" y="21.6" width="2.1" height="2.1" rx="0.4" />
          <rect x="20.0" y="21.6" width="2.1" height="2.1" rx="0.4" />
          <rect x="22.9" y="21.6" width="2.1" height="2.1" rx="0.4" />
          <rect x="25.7" y="21.6" width="2.1" height="2.1" rx="0.4" />
        </g>
        {/* Anchor stem — restrained cruise-port hint */}
        <path d="M20 25.5v5.4" stroke={accent} strokeWidth="1.45" strokeLinecap="round" />
        <path
          d="M16.4 29.4c1.1.9 2.3 1.4 3.6 1.4s2.5-.5 3.6-1.4"
          stroke={accent}
          strokeWidth="1.35"
          strokeLinecap="round"
        />
  ...
  // Concept A: Anchor Arch — a coastal arch meeting a restrained anchor.
  return (
    <svg
      width={size}
      height={size}
 ...
 *
 * Logo refinement: icon slightly subordinate to the destination wordmark,
...
export function DestinationLogo({
  ...
  const onDark = tone === "on-dark";
  // ~12% smaller than the initial draft so the destination wordmark stays dominant
